...
class RiskCalculator:
    ...
    def calculate_position_size(self, 
        ...
        """
        # Get account value
        account_value = self.account_manager.get_net_liquidation(account)
        if account_value <= 0:
    ...
    def validate_trade(self,
                      ...
                      shares: int,
                      direction: str,
                      account: Optional[str] = None) -> Tuple[bool, list]:
        """
